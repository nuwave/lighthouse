...
In this contrived example, the function is still pretty simple.
...
Ideally, we would want to write small and focused functions that each deal with just a part of the given input arguments.
