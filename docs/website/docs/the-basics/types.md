...
them in the [default schema](/docs/getting-started/installation.md#publish-the-default-schema).
...
Use the [@scalar](/docs/api-reference/directives.md#scalar) directive to point to any fully qualified class name:
...
the [@enum](/docs/api-reference/directives.md#enum) directive.
