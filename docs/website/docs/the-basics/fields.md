...
The [@all](directives.md#all) directive will assume the name of your model to be the same as
...
The easiest way to create data on your server is to use the [@create](directives.md#create) in combination
...
root types `Query` or `Mutation`, you can use the [@field](directives.md#field) directive. 
