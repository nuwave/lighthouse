...
- [`@all`](directives.md#all) just gets you a list of all `Post` models
- [`@find`](directives.md#find) and [`@eq`](directives.md#eq) are combined to retrieve a single `Post` by its ID
...
[`@belongsTo`](directives.md#belongsTo) and [`@hasMany`](directives.md#hasMany) directives.
...
- [Add pagination to your fields](directives.md#paginate)
- [Create and update posts and comments](fields.md#mutate-data)
- [Validate the inputs that are sent to your server](validation.md)
