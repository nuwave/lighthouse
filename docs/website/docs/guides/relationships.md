...
Use the [@hasOne](/docs/api-reference/directives.md#hasOne) directive to define a [one-to-one relationship](https://laravel.com/docs/eloquent-relationships#one-to-one)
...
The inverse can be defined through the [@belongsTo](/docs/api-reference/directives#belongsTo) directive.
...
Use the [@hasMany](/docs/api-reference/directives#hasMany) directive to define a [one-to-many relationship](https://laravel.com/docs/eloquent-relationships#one-to-many).
...
Again, the inverse is defined with the [@belongsTo](/docs/api-reference/directives#belongsTo) directive.
...
Use the [@belongsToMany](/docs/api-reference/directives#belongsToMany) directive to define it.
