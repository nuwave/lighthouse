...
To get a relay-compatible connection on a root query field, use the [@paginate](/docs/api-reference/directives.md#paginate)
...
in Eloquent. Use the [@hasMany](/docs/api-reference/directives.md#hasMany) directive.
...
[@model](/docs/api-reference/directives.md#model)

[@globalId](/docs/api-reference/directives.md#globalid)
