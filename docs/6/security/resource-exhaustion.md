...
These queries may be abusive queries from evil clients, or may simply be huge queries used by legitimate clients.
...
You can use the built-in security options through `config/lighthouse.php`.
