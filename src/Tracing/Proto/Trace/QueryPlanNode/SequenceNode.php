...
class SequenceNode extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @var array<\Nuwave\Lighthouse\Tracing\Proto\Trace\QueryPlanNode>|\Google\Protobuf\Internal\RepeatedField $nodes
     * }
     */
     ...
     * Generated from protobuf field <code>repeated .Trace.QueryPlanNode nodes = 1;</code>.
     *
     * @param  array<\Nuwave\Lighthouse\Tracing\Proto\Trace\QueryPlanNode>|\Google\Protobuf\Internal\RepeatedField  $var
     *
     * @return $this
     */
    public function setNodes(array|\Google\Protobuf\Internal\RepeatedField $var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Nuwave\Lighthouse\Tracing\Proto\Trace\QueryPlanNode::class);
        $this->nodes = $arr;
...
class_alias(SequenceNode::class, \Nuwave\Lighthouse\Tracing\Proto\Trace_QueryPlanNode_SequenceNode::class);
