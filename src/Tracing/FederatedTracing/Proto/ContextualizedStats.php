...
class ContextualizedStats extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $extended_references = null;
    /**
     ...
     *           Key is type name. This structure provides data for the count and latency of individual
     *           field executions and thus only reflects operations for which field-level tracing occurred.
     *     @type \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\ExtendedReferences $extended_references
     *           Extended references including input types and enum values.
     *     @type array|\Google\Protobuf\Internal\MapField $local_per_type_stat
     *           Per type stats that are obtained directly by the router or gateway rather than FTV1.
     *     @type \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\LimitsStats $limits_stats
     *           Stats that contain limits information for the query.
    ...
    {
        GPBUtil::checkMessage($var, \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\ExtendedReferences::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\LocalTypeStat::class);
    ...
    {
        GPBUtil::checkMessage($var, \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\LimitsStats::class);
