...
class Trace extends \Google\Protobuf\Internal\Message
{
     ...
     *           typically be at least 1.
     *           0 is treated as 1 for backwards compatibility.
     *     @type \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\Trace\Limits $limits
     *           The limits information of the query.
     * }
     */
    ...
    {
        GPBUtil::checkMessage($var, \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\Trace\Limits::class);
        $this->limits = $var;
