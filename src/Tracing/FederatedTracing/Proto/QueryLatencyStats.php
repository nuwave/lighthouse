...
class QueryLatencyStats extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type array<int>|array<string>|\Google\Protobuf\Internal\RepeatedField $cache_latency_count
     *           This array includes the latency buckets for all operations included in cache_hits
     *           See comment on latency_count for details.
     *     @type \Nuwave\Lighthouse\Tracing\FederatedTracing\Proto\PathErrorStats $root_error_stats
     *           Paths and counts for each error. The total number of requests with errors within this object should be the same as
     *           requests_with_errors_count below.
     *     @type int|string $requests_with_errors_count
     *           Total number of requests that contained at least one error
     *     @type array<int>|array<string>|\Google\Protobuf\Internal\RepeatedField $public_cache_ttl_count
     *     @type array<int>|array<string>|\Google\Protobuf\Internal\RepeatedField $private_cache_ttl_count
