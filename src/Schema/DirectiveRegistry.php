...
class DirectiveRegistry
{
     ...
     */
    public function load($paths, string $rootNamespace, string $pathForRootNamespace): self
    {
        $paths = collect($paths)
            ->unique()
     ...
     * @return DirectiveRegistry
     */
    public function tryRegisterClassName(string $className): self
    {
     ...
     * @return DirectiveRegistry
     */
    public function register(Directive $directive): self
    {
