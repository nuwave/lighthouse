...
use Nuwave\Lighthouse\Execution\DataLoader\RelationMaxLoader;
...
class WithMaxDirective extends WithRelationAggregateDirective implements FieldMiddleware, FieldManipulator
{
    public static function definition(): string
    {
        return /** @lang GraphQL */ <<<'GRAPHQL'
"""
Eager-load the max of an Eloquent relation if the field is queried.
